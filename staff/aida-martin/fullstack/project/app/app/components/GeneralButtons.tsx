  ...
  return (
    <div className="flex drop-shadow-lg items-center justify-center mt-auto text-white">
      <button
        ...
        className="bg-[#007cec] p-[6px_2px_6px_16px] flex items-center justify-center rounded-tl-2xl rounded-bl-2xl"
      >
        {!whislist ? <IconHeart size="24px" /> : <IconHeartFill size="24px" />}
      </button>
      <button
        onClick={handleAddToCollection}
        className="bg-[#007cec] p-[6px_16px_6px_2px] flex items-center justify-center rounded-tr-2xl rounded-br-2xl"
      >
        {!collection ? (
